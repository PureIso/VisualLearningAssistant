...
// //	File Name:		LabelNodeHead.xaml.cs
...
namespace VLALinkedList.Design
{
    /// <summary>
    ///     Interaction logic for LabelNode.xaml
    /// </summary>
    public partial class LabelNodeHead : UserControl
    {
        public LabelNodeHead()
        {
            InitializeComponent();
        }
    }
